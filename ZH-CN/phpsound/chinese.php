...
$LNG['ttl_comment_email'] = '%s 评论了您的足迹';
$LNG['comment_email'] = $LNG['email_hello'].'<strong><a href="%s">%s</a></strong> 评论了您的 <strong><a href="%s">track.</a></strong>'.$LNG['email_footer_unsub'];
$LNG['ttl_like_email'] = '%s 喜欢了您的足迹';
$LNG['like_email'] = $LNG['email_hello'].'<strong><a href="%s">%s</a></strong> 喜欢了您的 <strong><a href="%s">足迹.</a></strong>'.$LNG['email_footer_unsub'];
$LNG['ttl_new_friend_email'] = '%s 添加了您的c好友';
$LNG['new_friend_email'] = $LNG['email_hello'].'<strong><a href="%s">%s</a></strong> 添加了您的好友.'.$LNG['email_footer_unsub'];
$LNG['ttl_copyright_notification'] = '';
